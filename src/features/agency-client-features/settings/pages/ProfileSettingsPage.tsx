...
import AgencyUserProfileCard from "../components/UserProfileCard";
import AgencyCompanyProfile from "../components/CompanyProfile";
...
export default function ProfileSettingsPage() {
  ...
  const canViewCompanyProfile = useMemo(() => {
    ...
    return isTenantAdmin && Boolean(user?.tenantName);
  }, [user?.tenantName, user?.roles]);
  ...
  return (
    <div className="space-y-6 pb-10">
      <Header title="Profile" description="Manage your agency profile and business details." backbtnVisible={false} />
        ...
        {canViewCompanyProfile ? (
          <TabsContent value="company-profile" className="mt-0">
            <div className="mb-3 flex items-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-700">
              ...
              Company profile is visible because you are a tenant admin and your account is linked to an agency.
            </div>
