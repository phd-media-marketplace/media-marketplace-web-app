...
import type { CompanyProfile } from "../type";

export default function AgencyCompanyProfile() {
  ...
  const companyInitials = (user?.tenantName ?? "AG").slice(0, 2).toUpperCase();
  ...
  return (
    <Card className="border border-violet-100">
      <CardHeader>
        ...
        <p className="text-sm text-slate-500">Manage your agency company details and business information.</p>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="md:col-span-2 flex items-center gap-4 rounded-lg border border-primary/15 bg-primary/5 p-4">
            ...
            <Avatar className="h-20 w-20 overflow-visible border-2 border-white shadow ring-2 ring-primary/20">
              ...
              <AvatarFallback className="bg-primary/10 text-primary text-xl font-semibold">{companyInitials}</AvatarFallback>
