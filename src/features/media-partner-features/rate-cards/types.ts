...
export interface FMSegment {
  segmentsTypes: string; // e.g., "Announcement", "Interview", "Live Presenter Mention", "Jingle", "News Coverage"
...
export interface TVSegment {
  segmentType: string; // e.g., "Spot Advert", "Documentary", "Announcement", etc.
